...
public class MainActivity extends AppCompatActivity {
    ...
    String clienteID = "";
    //mqtt://:@
    static String MQTTHOST = "tcp://trabajo-mqtt.cloud.shiftr.io:1883";
    static String MQTTUSER = "trabajo-mqtt";
    static String MQTTPASS = "N3f5gP6X7W6oyrcW";
